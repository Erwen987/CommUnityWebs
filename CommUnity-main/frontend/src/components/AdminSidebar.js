  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="menu">
        ...
        <Link to="/admin/requests" className={isActive('/admin/requests')}>
        ...
        <Link to="/admin/rewards" className={isActive('/admin/rewards')}>
      ...
      <div className="logout">
        <Link to="/admin/settings" className={isActive('/admin/settings')} style={{ marginBottom: '8px' }}>
